from dlc_implementation.model_dependencies.weight_init import BaseWeightInitializer, Normal

from abc import ABC, abstractmethod

import torch
import torch.nn as nn
from dlc_implementation.models.criterions.base import BaseCriterion, BaseLossAggregator
    ...
    def __init__(
        ...
        if isinstance(weight_init, BaseWeightInitializer):
            ...
            if weight_init != 'normal':
                raise Exception(f"Can't load in weight init type : {weight_init}")
